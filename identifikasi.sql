...
(31, 'Tu-160M Blackjack', 'bawah', 'tidak ada kemiringan', 'kebelakang', 'lancip dibelakang', 'turbo', 'empat', 'belakang', 'bulat', 'runcing', 'tabung', 'ditengah ekor', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(32, 'Sukhoi SU-57', 'atas', 'tidak ada kemiringan', 'delta', 'lancip dibelakang', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'sirip tidak ada', 'bersenjata', 'loreng'),
(33, 'F-15C Eagle', 'atas', 'tidak ada kemiringan', 'semi delta', 'lancip dibelakang', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'sirip tidak ada', 'bersenjata', 'polos'),
(34, 'L-39 Albatros', 'bawah', 'tidak ada kemiringan', 'lurus', 'lancip rata', 'turbo', 'satu', 'belakang', 'ramping', 'runcing', 'menonjol', 'diatas badan', 'tiga', 'lancip tidak rata dan ujung melengkung', 'tidak bersenjata', 'loreng'),
(35, 'Tupolev Tu-22m', 'bawah', 'positif', 'kebelakang', 'lancip dibelakang', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'tiga', 'lancip rata dan ujung kotak', 'bersenjata', 'polos'),
(36, 'Yakovlev Yak-130', 'tengah', 'tidak ada kemiringan', 'delta', 'lancip dibelakang', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'menonjol', 'ditengah badan', 'tiga', 'lancip rata dan ujung kotak', 'bersenjata', 'polos'),
(37, 'Shenyang J-31', 'atas', 'tidak ada kemiringan', 'delta', 'lancip dibelakang', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'sirip tidak ada', 'bersenjata', 'polos'),
(38, 'Shenyang J-15', 'atas', 'tidak ada kemiringan', 'semi delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'dibawah badan', 'empat', 'sirip tidak ada', 'bersenjata', 'polos'),
(39, 'Xian H-20', 'tengah', 'negatif', 'semi delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'kotak', 'bulat', 'menonjol', 'ditengah badan', 'ganda', 'sirip tidak ada', 'bersenjata', 'polos'),
(40, 'Xian H-6', 'tengah', 'tidak ada kemiringan', 'kebelakang', 'lancip kebelakang', 'turbo', 'satu', 'belakang', 'bulat', 'bulat', 'tabung', 'dibawah ekor', 'tiga', 'lancip rata dan ujung kotak', 'bersenjata', 'polos'),
(41, 'Xian JH-7', 'atas', 'negatif', 'semi delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'tabung', 'diatas badan', 'tiga', 'kebelakang dan ujung tumpul', 'bersenjata', 'polos'),
(42, 'Hongdu JL-15', 'tengah', 'tidak ada kemiringan', 'delta', 'lancip dibelakang', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'ditengah badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'polos'),
(43, 'BAE System Hawk', 'bawah', 'tidak ada kemiringan', 'kebelakang', 'kebelakang dan lancip', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'tiga', 'lancip tidak rata dan ujung melengkung', 'tidak bersenjata', 'polos'),
(44, 'Dassault Rafale', 'atas', 'tidak ada kemiringan', 'delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'tunggal', 'lancip tidak rata dan ujung melengkung', 'bersenjata', 'polos'),
(45, 'F-22 Raptor', 'atas', 'negatif', 'delta', 'bentuk berlian', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'lancip rata dan ujung kotak', 'bersenjata', 'polos'),
(46, 'Chengdu J-10', 'atas', 'tidak ada kemiringan', 'delta', 'kebelakang dan lancip', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'tunggal', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'polos'),
(47, 'T-38B Talon', 'bawah', 'tidak ada kemiringan', 'semi delta', 'lancip dibelakang', 'turbo', 'satu', 'belakang', 'tebal', 'runcing', 'menonjol', 'diatas badan', 'tiga', 'lancip rata dan ujung kotak', 'bersenjata', 'polos'),
(48, 'Sukhoi SU-34', 'tengah', 'tidak ada kemiringan', 'semi delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'kebelakang dan ujung tumpul', 'bersenjata', 'loreng'),
(49, 'F-35 Lightning II', 'atas', 'negatif', 'delta', 'bentuk berlian', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'menonjol', 'ditengah badan', 'empat', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'polos'),
(50, 'Boeing C-17 Globemaster III', 'atas', 'negatif', 'kebelakang', 'lancip kebelakang', 'turbo', 'empat', 'depan dan belakang', 'tebal', 'bulat', 'tabung', 'diatas ekor', 'tunggal', 'lancip rata dan ujung kotak', 'tidak bersenjata', 'polos'),
(51, 'V-22 Osprey', 'atas', 'negatif', 'lurus', 'lancip rata', 'baling-baling', 'dua', 'depan dan belakang', 'kotak', 'bulat', 'menonjol', 'diatas badan', 'ganda', 'lancip rata dan ujung kotak', 'tidak bersenjata', 'polos'),
(52, 'Northrop Grumman B-2 Spirit', 'bawah', 'negatif', 'semi delta', 'kebelakang dan lancip', 'turbo', 'empat', 'belakang', 'kotak', 'bulat', 'menonjol', 'ditengah badan', 'ganda', 'sirip tidak ada', 'bersenjata', 'polos'),
(53, 'Xian Y-20', 'atas', 'negatif', 'kebelakang', 'lancip kebelakang', 'turbo', 'empat', 'depan dan belakang', 'tebal', 'bulat', 'menonjol', 'diatas ekor', 'tunggal', 'lancip rata dan ujung kotak', 'tidak bersenjata', 'polos'),
(54, 'Shaanxi Y-9', 'atas', 'negatif', 'lurus', 'lancip rata', 'baling-baling', 'empat', 'depan dan belakang', 'tebal', 'bulat', 'menonjol', 'diatas ekor', 'tunggal', 'lancip rata dan ujung kotak', 'tidak bersenjata', 'polos'),
(55, 'Eurofighter Typhoon', 'bawah', 'tidak ada kemiringan', 'delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'tebal', 'runcing', 'menonjol', 'diatas badan', 'tunggal', 'lancip tidak rata dan ujung melengkung', 'bersenjata', 'polos'),
(56, 'Chengdu J-20', 'atas', 'negatif', 'delta', 'bentuk berlian', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'loreng'),
(57, 'Mikoyan MiG-31', 'atas', 'negatif', 'semi delta', 'lancip kebelakang', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'polos'),
(58, 'Boeing EA-18G Growler', 'tengah', 'tidak ada kemiringan', 'kebelakang', 'lancip dibelakang', 'turbo', 'dua', 'belakang', 'kotak', 'runcing', 'menonjol', 'diatas badan', 'empat', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'polos'),
(59, 'F-16 Fighting Falcon', 'tengah', 'tidak ada kemiringan', 'semi delta', 'lancip dibelakang', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'menonjol', 'ditengah badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'bersenjata', 'polos'),
(60, 'Rockwell B-1 Lancer', 'bawah', 'tidak ada kemiringan', 'kebelakang', 'lancip kebelakang', 'turbo', 'satu', 'belakang', 'kotak', 'runcing', 'tabung', 'dibawah ekor', 'tiga', 'lancip tidak rata dan ujung melengkung', 'bersenjata', 'polos'),
(61, 'Alenia C-27J Spartan', 'atas', 'tidak ada kemiringan', 'lurus', 'lancip rata', 'baling-baling', 'dua', 'depan dan belakang', 'tebal', 'bulat', 'tabung', 'diatas badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(62, 'Shaanxi KJ-500', 'atas', 'tidak ada kemiringan', 'lurus', 'lancip rata', 'baling-baling', 'empat', 'depan dan belakang', 'tebal', 'bulat', 'tabung', 'diatas badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'loreng'),
(63, 'Airbus A400M Atlas', 'atas', 'negatif', 'lurus', 'lancip rata', 'baling-baling', 'empat', 'depan dan belakang', 'tebal', 'bulat', 'tabung', 'diatas ekor', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(64, 'Boeing E-3 Sentry', 'tengah', 'tidak ada kemiringan', 'kebelakang', 'lancip kebelakang', 'turbo', 'empat', 'depan dan belakang', 'bulat', 'bulat', 'tabung', 'ditengah badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(65, 'Beriev A-50', 'atas', 'negatif', 'kebelakang', 'lancip kebelakang', 'turbo', 'empat', 'depan dan belakang', 'tebal', 'bulat', 'tabung', 'diatas ekor', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'loreng'),
(66, 'Boeing 737 AEWC', 'tengah', 'tidak ada kemiringan', 'kebelakang', 'lancip kebelakang', 'turbo', 'dua', 'depan dan belakang', 'bulat', 'bulat', 'tabung', 'ditengah badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(67, 'DRDO AEWCS', 'bawah', 'tidak ada kemiringan', 'kebelakang', 'lancip kebelakang', 'turbo', 'dua', 'depan dan belakang', 'bulat', 'runcing', 'tabung', 'ditengah badan', 'tiga', 'lancip rata dan ujung kotak', 'tidak bersenjata', 'polos'),
(68, 'Boeing P-8 Poseidon', 'tengah', 'tidak ada kemiringan', 'kebelakang', 'lancip kebelakang', 'turbo', 'dua', 'depan dan belakang', 'bulat', 'runcing', 'tabung', 'ditengah badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(69, 'Saab 340 AEWC', 'bawah', 'positif', 'lurus', 'lancip tidak rata', 'baling-baling', 'dua', 'depan dan belakang', 'bulat', 'runcing', 'tabung', 'ditengah badan', 'tiga', 'meruncing kebelakang dan ujung kotak', 'tidak bersenjata', 'polos'),
(70, 'Sukhoi SU-35', 'atas', 'tidak ada kemiringan', 'semi delta', 'kebelakang dan lancip', 'turbo', 'dua', 'belakang', 'bulat', 'runcing', 'menonjol', 'diatas badan', 'empat', 'kebelakang dan ujung tumpul', 'bersenjata', 'loreng');
